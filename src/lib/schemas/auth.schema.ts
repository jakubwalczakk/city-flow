...
export const loginSchema = z.object({
  email: z.string({ message: 'Email jest wymagany' }).min(1, 'Email jest wymagany').email('Nieprawidłowy format email'),
  password: z.string({ message: 'Hasło jest wymagane' }).min(1, 'Hasło jest wymagane'),
});
