...
describe('PlanSummaryCard', () => {
  ...
  describe('rendering', () => {
    it('should render card title', () => {
      ...
      expect(screen.getByText('Podsumowanie planu')).toBeInTheDocument();
    });

    it('should render AI badge', () => {
      render(<PlanSummaryCard summary={mockSummary} />);

      expect(screen.getByText('Wygenerowano przez AI')).toBeInTheDocument();
    });
    ...
    it('should render disclaimer text', () => {
      ...
      expect(screen.getByText(/Ten plan został wygenerowany przez sztuczną inteligencję/)).toBeInTheDocument();
    });

    it('should render disclaimer with proper styling', () => {
      render(<PlanSummaryCard summary={mockSummary} />);

      const disclaimer = screen.getByText(/Ten plan został wygenerowany przez sztuczną inteligencję/);
  ...
  describe('content variations', () => {
    ...
    it('should render long summary', () => {
      ...
      const summaryElement = screen.getByText(/Lorem ipsum dolor sit amet/);
    ...
    it('should render summary with line breaks', () => {
      ...
      expect(screen.getByText(/Pierwsza linia/)).toBeInTheDocument();
    });
  });
  ...
  describe('layout', () => {
    it('should have AI badge in header', () => {
      ...
      expect(header).toContainElement(screen.getByText('Wygenerowano przez AI'));
    });
  ...
  describe('styling', () => {
    it('should have primary colored AI badge', () => {
      ...
      const badge = screen.getByText('Wygenerowano przez AI').parentElement;
  ...
  describe('accessibility', () => {
    ...
    it('should have proper heading hierarchy', () => {
      ...
      const title = screen.getByText('Podsumowanie planu');
